            ...
            <section class="full-box page-content">
                ...
                <div class="container-fluid">
                    <ul class="full-box list-unstyled page-nav-tabs">
                        ...
                        <li>
                            <a  href="srvUsuario?accion=listarUsuarios"><i class="fas fa-users fa-fw"></i> &nbsp; LISTA DE USUARIOS</a>
                        </li>
                    </ul>	
                </div>
                ...
                <!-- Content -->
                <div class="container-fluid">
                    <form action="srvUsuario?accion=registrar" class="form-neon" method="post">
                        <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" pattern="[a-zA-Z]{1,15}" class="form-control" id="nombre" name="txtNombre" maxlength="15" value="">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" id="nombre" name="txtClave" maxlength="50" value="">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
