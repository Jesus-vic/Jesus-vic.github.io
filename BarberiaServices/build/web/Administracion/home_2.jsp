...
<%
    if (session.getAttribute("barbero") != null) {
%>
<!DOCTYPE html>
<html lang="es">
    <head>
                ...
                <div class="full-box nav-lateral-content">
                    <figure class="full-box nav-lateral-avatar">
                        ...
                        <figcaption class="roboto-medium text-center">
                            <p>                    
                                Bienvenido - ${barbero.nombreUsuario}
                                <small>Usted es,${barbero.cargo.nombreCargo} </small>
                            </p>
                    ...
                    <nav class="full-box nav-lateral-menu">
                        <ul>
                            <li>
                                <a href="home_2.jsp"><i class="fab fa-dashcube fa-fw"></i> &nbsp; Inicio</a>
                            </li>
