        ...
        <main class="full-box main-container">
            ...
            <section class="full-box page-content">
                ...
                <div class="full-box page-header">
                    <h3 class="text-left">
                        <i class="fas fa-boxes fa-fw"></i> &nbsp; LISTA DE CLIENTES
                    </h3>
                ...
                <div class="container-fluid">
                    <ul class="full-box list-unstyled page-nav-tabs">
                        <li>
                            <a href="Administracion/product.jsp"><i class="fas fa-box fa-fw"></i> &nbsp; NUEVO CLIENTE</a>
                        </li>
                        <li>
                            <a class="active" href="productlist.jsp"><i class="fas fa-boxes fa-fw"></i> &nbsp; LISTA DE CLIENTES</a>
                        </li>
                    </ul>	
                </div>
                        ...
                        <table class="table table-dark table-sm">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center" >
                                    <td>4</td>
                                    <td>109824321</td>
                                    <td>Richard Galindo</td>
                                    <td>cabello corto delineado</td>
                                    <td>s/60.00 soles</td>
                                    <td>
                                        <button type="button" class="btn btn-success">
                                            <i class="fas fa-sync-alt"></i>
