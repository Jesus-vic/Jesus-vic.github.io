        ...
        <main class="full-box main-container">
                    ...
                    <nav class="full-box nav-lateral-menu">
                        <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="product.jsp"><i class="fas fa-box fa-fw"></i> &nbsp; Nuevo usuario</a></li>
                                    <li><a href="productlist.jsp"><i class="fas fa-boxes fa-fw"></i> &nbsp; Lista de usuarios</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="base.jsp"><i class="fas fa-columns fa-fw"></i> &nbsp; Horarios</a>
                            </li>
            ...
            <section class="full-box page-content">
                ...
                <div class="full-box page-header">
                    <h3 class="text-left">
                        <i class="fab fa-dashcube fa-fw"></i> &nbsp; BARBERIA DURAND
                    </h3>
                ...
                <div class="full-box tile-container">
                    ...
                    <a href="srvUsuario?accion=listarUsuarios" class="tile">
                    ...
                    <a href="#" class="tile">
                        <div class="tile-tittle">Lista de clientes</div>
                        <div class="tile-icon">
                    ...
                    <a href="#" class="tile">
                        <div class="tile-tittle">List proveedores</div>
                        <div class="tile-icon">
