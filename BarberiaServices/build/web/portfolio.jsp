        ...
        <div class="portfolio">
            <div class="container">
                <div class="section-header text-center">
                    <p>Galería de imágenes de barberos</p>
                    <h2>Algunas imágenes de nuestra galería de peluquería</h2>
                </div>
                <div class="row">
                    <div class="col-12">
                        <ul id="portfolio-flters">
                            <li data-filter="*" class="filter-active">Todo</li>
                            <li data-filter=".first">Corte de pelo</li>
                            <li data-filter=".second">Estilo de barba</li>
                            <li data-filter=".third">Color y lavado</li>
                        </ul>
                    </div>
                </div>
                <div class="row portfolio-container">
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item first">
                        <div class="portfolio-wrap">
                            <a href="RESOURCES/img/portfolio-1.jpg" data-lightbox="portfolio">
                                <img src="RESOURCES/img/portfolio-1.jpg" alt="Portfolio Image">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item second">
                        <div class="portfolio-wrap">
                            <a href="RESOURCES/img/portfolio-2.jpg" data-lightbox="portfolio">
                                <img src="RESOURCES/img/portfolio-2.jpg" alt="Portfolio Image">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item third">
                        <div class="portfolio-wrap">
                            <a href="RESOURCES/img/portfolio-3.jpg" data-lightbox="portfolio">
                                <img src="RESOURCES/img/portfolio-3.jpg" alt="Portfolio Image">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item first">
                        <div class="portfolio-wrap">
                            <a href="RESOURCES/img/portfolio-4.jpg" data-lightbox="portfolio">
                                <img src="RESOURCES/img/portfolio-4.jpg" alt="Portfolio Image">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item second">
                        <div class="portfolio-wrap">
                            <a href="RESOURCES/img/portfolio-5.jpg" data-lightbox="portfolio">
                                <img src="RESOURCES/img/portfolio-5.jpg" alt="Portfolio Image">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item third">
                        <div class="portfolio-wrap">
                            <a href="RESOURCES/img/portfolio-6.jpg" data-lightbox="portfolio">
                                <img src="RESOURCES/img/portfolio-6.jpg" alt="Portfolio Image">
                            </a>
                        </div>
                    </div>
                </div>
